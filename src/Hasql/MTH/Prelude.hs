...
import Data.Foldable                        as Exports (Foldable, foldMap, foldl', toList)
...
import Data.List                            as Exports (length, map, splitAt)
import Data.List.NonEmpty                   as Exports (NonEmpty (..))
import Data.Map.Strict                      as Exports (Map)
import Data.Maybe                           as Exports (Maybe(..), maybe)
...
import Prelude                              as Exports (Char, Int, Integral, Show, String, (+), fromIntegral, show)
